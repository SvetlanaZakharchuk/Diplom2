...
public class OrderCreateTest {
    ...
    public void createOrderWithAuthorizationTest() {
        ...
        File json = new File("src/main/resources/IngredientsInfo.json");
    ...
    public void createOrderNoIngredients() {
        File json = new File("src/main/resources/NoInrgredientsInfo.json");
        Response response = orderClient.createOrderWithIngredients(json);
    ...
    public void createOrderWithInvalidHash() {
        File json = new File("src/main/resources/InvalidHashIngredients.json");
        Response response = orderClient.createOrderWithIngredients(json);
